...
path('listarCategorias', views.listarCategorias.as_view(), name='listartCategorias'),
path('listarMarcas', views.listarMarcas.as_view(), name='listarMarcas'),
path('AgregarCategoriaProducto', views.AgregarCategoriaProducto.as_view(), name='agregarCategoria'),
path('AgregarMarcaProducto', views.AgregarMarcaProducto.as_view(), name='agregarMarca'),
...
path('EditarMarca/<int:p>', views.EditarMarca.as_view(), name='editarMarca'),
path('ListadodeProductos', views.ListadodeProductos.as_view(), name='ListadodeProductos'),
path('ListadodeProductosMarca', views.ListadodeProductosMarca.as_view(), name='ListadodeProductosMarca'),
path('GenerarListadoCatProdPDF',views.GenerarListadoCatProdPDF.as_view(), name='GenerarListadoCatProdPDF'),
path('GenerarListadoMrkProdPDF',views.GenerarListadoMrkProdPDF.as_view(), name='GenerarListadoMrkProdPDF'),
